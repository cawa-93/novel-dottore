label scene9_1:
    image day marker = Text(_("День 12"), size=120)
    ...
    # TODO: Додати картинку
    """
    Треба проілюструвати. «Нова» шкіра на твоїх руках і ногах виглядає жахливо.

    Через кілька днів після операції у тебе раптово піднялась температура, яку вчений безуспішно намагався знизити за допомогою відварів трав. Ти не пам’ятаєш, скільки це тривало, день, тиждень чи місяць, адже свідомість перебувала на межі свідомості і непритомності.
    ...
    Разом із смородом матрац, який став твоїм особистим куточком у лабораторії, всотав у себе і липку каламутну рідину, яка весь час сочилася з-під гниючої шкіри. Крапля за краплею вона розливалась по тканині, лишаючись там мокрою гидкою калюжею.

    Тобі хочеться плакати, але навіть на це немає сил. Кінець ілюстрування
    """
    ...
    "Треба проілюструвати. Дотторе бере пінцет і піддіває краєчок почорнілої шкіри."
    ...
    Я думаю, що пора його прибрати більш радикально, як вважаєш?" Кінець ілюстрації
    """
