label scene7_2:
    ...
    Ти лежиш на підлозі на якомусь брудному матраці.
    
    Здається, до тебе тут вже побувало багато «пацієнтів» Дотторе, адже вся поверхня покрита багряними плямами.
    ...
    Хочеться видерти всі нутрощі з себе, але ти намагаєшся заспокоїтись і згадати ті часи, коли у тебе підіймалась температура тіла.
    
    Тоді тобі теж було настільки погано, що хотілось втопитись у найближчому озері, але вже за кілька днів тобі було соромно за такі свої думки, адже самопочуття покращувалось.
