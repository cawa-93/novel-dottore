...
label scene4_variant2:
    ...
    """
    Сонце зовсім зайшло за горизонт і стало набагато прохолодніше. 
    
    Ти кутаєшся в дорожній плащ та непомітно для вченого позіхаєш, прикривши рота долонею. 
    
    Довго дорога сильно втомила тебе, а ситна вечеря – в кінець розморила.
