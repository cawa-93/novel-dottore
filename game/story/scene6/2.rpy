label scene6_2:
    ...
    show dottore lab test tube 2

    DT "Хах. Ніхто з попередніх пацієнтів не обирав ні голки, ні ножі, ні пилки. Всі чомусь вважать, що рідини менш… небезпечні та болючі."
    GG "…"
    GG "Що у пробірці?"
    ...
    DT "Кальцій це такий елемент, з якого складаються кістки, зуби та деякі інші тверді частини нашого тіла. Саме тому елеазар такий міцний і при розростанні не дозволяє суглобам нормально рухатись."
    ...
    Тобі страшно, але ти не можеш сказати жодного слова.
    
    Язик прилип до піднебіння та занімів, що є твоєю типовою реакцією на стресову ситуацію.
    """
