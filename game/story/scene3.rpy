...
label scene3:
    ...
    Ти приречено чухаєш в одну нігтем і розчаровано розумієш, що нарости стали більш твердими у порівнянні з тими, якими ти їх запам’ятала перед початком своєї подорожі.
